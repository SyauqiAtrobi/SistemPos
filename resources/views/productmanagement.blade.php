            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4 py-3 d-flex align-items-center gap-3">
                        <img src="{{ $p->image ? '/storage/'.$p->image : 'https://via.placeholder.com/45' }}" alt="{{ $p->name }}" class="product-thumb" onerror="this.onerror=null;this.src='https://via.placeholder.com/45';">
                        <div>
